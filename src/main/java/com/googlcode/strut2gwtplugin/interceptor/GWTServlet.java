...
class GWTServlet {
    ...
    public String processCall(String payload) throws SerializationException {
        ...
        //
        Method serviceIntfMethod = findInterfaceMethod(actionInvocation.getAction().getClass(), methodName, paramTypes, true);
        ...
        try {
            ...
            Object returnVal = serviceIntfMethod.invoke(actionInvocation.getAction(), args);
        ...
        if(caught != null) {
            ...
            if(servletContext != null) {
                ...
                servletContext.log(
                    "Exception while dispatching incoming RPC call", caught);
            }
        }
     ...
     */
    private boolean isImplementedRemoteServiceInterfaceRecursive(
        String intfName, Class intfToCheck) {
    ...
    private void writeResponse(HttpServletRequest request,
        ...
        if(acceptsGzipEncoding(request)
            ...
            if(caught != null) {
                getServletContext()
                    .log("Unable to compress response", caught);
                response
